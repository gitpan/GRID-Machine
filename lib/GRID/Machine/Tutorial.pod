...
Do you like Perl? What about having perl interpreters running in 
those computers you have an account and make them to 
collaborate to give you more computational power (and more fun)?
...
This tutorial also introduces a set of techniques used to debug 
parallel perl code that is being executed in a I<Remote> computer.
...
=head1 BUILDING A "FUZZY" PARALLEL CLUSTER: INTRODUCTION TO AUTOMATIC AUTHENTICATION WITH SSH
